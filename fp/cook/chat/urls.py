...
urlpatterns = [
    ...
    path("api/chat/history/<int:session_id>/", chat_history, name="chat_history"),  # ✅ 특정 채팅 내역 조회
    path("api/chat/delete/<int:session_id>/", delete_chat, name="delete_chat"),  # ✅ 특정 채팅 삭제
]