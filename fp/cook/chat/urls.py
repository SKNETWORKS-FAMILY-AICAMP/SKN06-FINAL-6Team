...
from .views import chat_view, chat_api, new_chat, chat_history, chat_sessions, delete_chat, save_final_recipe

urlpatterns = [
    path("", chat_view, name="chat"),
    path("api/chat/", chat_api, name="chat_api"),
    path("api/new_chat/", new_chat, name="new_chat"),
    path("api/chat/<int:chat_id>/", chat_history, name="chat_history"),
