...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # cookit 폴더
DJANGO_DIR = os.path.join(BASE_DIR, "cook", "cook")  # Django 프로젝트 폴더 (settings.py가 있는 폴더)
APP_DIR = os.path.join(BASE_DIR, "cook")  # Django 앱들이 있는 폴더

# Django 프로젝트 경로를 sys.path에 추가
sys.path.insert(0, BASE_DIR)  # cookit 추가
sys.path.insert(0, APP_DIR)  # cook 추가
sys.path.insert(0, DJANGO_DIR)  # settings.py가 있는 cook/cook 추가
