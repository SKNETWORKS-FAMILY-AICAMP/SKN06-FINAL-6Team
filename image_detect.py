...
# YOLO 모델 파일 경로
yolo_model_food = YOLO(os.path.join(BASE_DIR, "runs", "detect", "train_식재료", "weights", "best.pt"))
yolo_model_fridge = YOLO(os.path.join(BASE_DIR,"runs", "detect","train_냉장고","weights","best.pt"))
