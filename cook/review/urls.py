...
from .views import review_list, review_detail, review_create, review_update, user_reviews, review_like, add_comment, delete_comment, add_reply, delete_reply, delete_review_image
...
urlpatterns = [
    ...
    path("comment/<int:comment_id>/delete/", views.delete_comment, name="delete_comment"),  # 댓글 삭제
    ...
    path("review/delete_image/<int:image_id>/", views.delete_review_image, name="delete_review_image")
]
