...
def func(query=None):
    ...
    ## vecotrdb 로드
    fais = FAISS.load_local("./chat/faiss/fun_faiss", embeddings, allow_dangerous_deserialization=True) # 로컬 저장 로드
...
def ref(query=None):
    ...
    ## vectordb 로드
    fais = FAISS.load_local("./chat/faiss/ref_faiss", embeddings, allow_dangerous_deserialization=True)
...
def man(query=None):
    ...
    # vectordb 로드
    fais = FAISS.load_local("./chat/faiss/man_faiss", embeddings, allow_dangerous_deserialization=True)
